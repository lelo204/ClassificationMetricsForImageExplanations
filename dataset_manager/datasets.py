...
class CarsnCatsDataset(BasicDataset):
    @classmethod
    def load_dataset(cls):
        csv_path = DatasetPaths.CarsnCats.csv_path
        data_folder = DatasetPaths.CarsnCats.images_folder
        return cls(csv_path, data_folder)
    
    
class MountainDogsDataset(BasicDataset):
    @classmethod
    def load_dataset(cls):
        csv_path = DatasetPaths.MountainDogs.csv_path
        data_folder = DatasetPaths.MountainDogs.images_folder
        return cls(csv_path, data_folder)
...
class CarsnCatsMosaic(MosaicDataset):
    @classmethod
    def load_dataset(cls):
        csv_path = MosaicPaths.CarsnCatsMosaic.csv_path
        data_folder = MosaicPaths.CarsnCatsMosaic.images_folder
        return cls(csv_path, data_folder)
    
    
class MountainDogsMosaic(MosaicDataset):
    @classmethod
    def load_dataset(cls):
        csv_path = MosaicPaths.MountainDogsMosaic.csv_path
        data_folder = MosaicPaths.MountainDogsMosaic.images_folder
        return cls(csv_path, data_folder)
